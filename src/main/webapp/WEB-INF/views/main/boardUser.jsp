...
<html lang="en">
  <head>
	...
	<script type="text/javascript">
	    ...
	    function page(idx){
	    	var boardCode = "BOARD_USER";
	    	
	        var pagenum = idx;              
	        location.href="${pageContext.request.contextPath}/main/boardUser?pagenum="+pagenum+"&boardCode="+boardCode;    
	    }
        ...
        function boardWrite(boardCode){            
            
            url = "${pageContext.request.contextPath}/main/boardNoticeWrite?boardCode="+boardCode; 
	      ...
	      <div class="row">
	        ...
	        <div class="col-sm-3 col-md-2 sidebar">
	          <ul class="nav nav-sidebar">
	            <li class=""><a href="javascript:go_it('BOARD_NOTICE');"><spring:message code="notice" text="default text" /><span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="javascript:go_it('BOARD_USER');"><spring:message code="community" text="default text" /></a></li>
	        </div>
	        <!--/ LEFT MENU     LEFT MENU     LEFT MENU     LEFT MENU     LEFT MENU     LEFT MENU     LEFT MENU     LEFT MENU     LEFT MENU         -->
	        ...
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              <div>
                <form class="form-inline" >
                  ...
                  <button type="button" class="btn btn-primary"  onclick="boardWrite('BOARD_NOTICE')" >작성</button>
                </form>
              </div>
          ...
          <nav>
            <ul class="pager">
              ...
              <c:choose>
                <c:when test="${page.prev}">
                  <li class="page-item">
                    <a class="page-link" href="javascript:page(${page.getStartPage()-1});">Previous</a>
                  </li>
                </c:when>
                <c:otherwise>
            ...
            <c:choose>
              <c:when test="${page.next}">
                <li class="page-item">
                  <a class="page-link" href="javascript:page(${page.getEndPage()+1});">Next</a>
                </li>
              </c:when>
              <c:otherwise>
                <li class="page-item disabled">
