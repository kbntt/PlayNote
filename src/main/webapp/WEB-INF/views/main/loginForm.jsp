    ...
    <script type="text/javascript">
        ...
        function go_it(type){
             ...
             $.ajax({
                 ...
                 url : "/main/signIn",//호출 URL을 설정한다. GET방식일경우 뒤에 파라티터를 붙여서 사용해도된다.
                 data: data, 
                 async: true,
    ...
    <form name="form" method="post">
        <div class="container">
		        <div class="div-signin">
		          ...
		          <button  type="button"  class="btn btn-lg btn-primary btn-block" onclick="javascript:go_it('SIGN_IN');">Sign in</button>
		          <button  type="button"  class="btn btn-lg btn-primary btn-block" onclick="javascript:go_register('REGISTER');">회원가입</button>
		        </div>
				<!-- Modal 창 -->
