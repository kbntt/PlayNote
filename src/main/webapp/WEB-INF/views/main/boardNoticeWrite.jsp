    ...
    <script type="text/javascript">
        ...
        function go_save(type){
             ...
             $.ajax({
                 ...
                 processData: false,
                 contentType: false,
                 url : "/main/boardNoticeAddMult",//호출 URL을 설정한다. GET방식일경우 뒤에 파라티터를 붙여서 사용해도된다.
                 data: formData, 
                 async: true,
        ...
        function success(){
            ...
            location.href="${pageContext.request.contextPath}/main/boardNotice?pagenum=1&boardCode="+boardCode;
        }  
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  <div class="input-group">
                    <span class="input-group-addon"><spring:message code="title" text="default text" /></span>
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="...">
                ...
                <input type="button" class="btn btn-default" value="<spring:message code="cancel" text="default text" />"  onclick="javascript:go_it('BOARD_NOTICE');">
              </div>
