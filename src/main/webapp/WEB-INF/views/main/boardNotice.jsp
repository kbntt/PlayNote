...
<html lang="en">
  <head>
	...
	<script type="text/javascript">
	    ...
	    function page(idx){
	    	var boardCode = "BOARD_NOTICE";
	    	
	        var pagenum = idx;              
	        location.href="${pageContext.request.contextPath}/main/boardNotice?pagenum="+pagenum+"&boardCode="+boardCode;    
	    }
	      ...
	      <div class="row">
	        ...
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              <div>
                ...
                <!-- Modal 창 -->
                <div id="Modal" class="alert alert-warning" style="display:none;">
                  <a href="javascript:close();" class="close" aria-label="close">&times;</a> 
                  <strong>Warning!</strong> 로그인 후 작성하세요.
                </div>
              </div>			  
